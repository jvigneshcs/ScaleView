...
@IBDesignable public class GradientScaleView: ScaleView {
    
    @IBInspectable public var initialTrackImage: UIImage?
    @IBInspectable public var trackImage: UIImage?
    @IBInspectable public var gradientStartColor: UIColor = .yellow
    @IBInspectable public var gradientEndColor: UIColor = .orange
    @IBInspectable public var gradientContainerBackgroundColor: UIColor = .white
    ...
    private func initializeGradientContainerView() {
        if gradientContainerView == nil {
            ...
            if let superView = superview {
                ...
                superView.sendSubviewToBack(gradientContainerView)
            }
        }
    ...
    private func updateGradientContainerView() {
        if gradientContainerView?.superview == nil {
            if let superView = superview, let containerView = gradientContainerView {
                ...
                superView.sendSubviewToBack(containerView)
            }
        }
        gradientContainerView?.frame = frame
    }
