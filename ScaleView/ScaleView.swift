...
@IBDesignable public class ScaleView: UIControl {
    
    @IBInspectable public var markColor: UIColor = .darkGray
    @IBInspectable public var selectedMarkColor: UIColor = .white
    
    @IBInspectable public var markWidth: CGFloat = 1
    @IBInspectable public var markHeight: CGFloat = 6
    @IBInspectable public var subMarkWidth: CGFloat = 1
    @IBInspectable public var subMarkHeight: CGFloat = 3
    @IBInspectable public var markValueStart: UInt8 = 0
    @IBInspectable public var markValueInterval: UInt8 = 10
    @IBInspectable public var markCount: UInt8 = 11
    @IBInspectable public var subMarkCount: UInt8 = 9
    @IBInspectable public var subMarkBufferCount: UInt8 = 0
    @IBInspectable public var needSelectedColorChange: Bool = false
    @IBInspectable public var drawMarksOnTop: Bool = true
    @IBInspectable public var drawMarksOnBottom: Bool = true
